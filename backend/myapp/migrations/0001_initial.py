# Generated by Django 2.2.4 on 2019-09-10 20:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='UserRole',
            fields=[
                ('idUserRole', models.AutoField(primary_key=True, serialize=False)),
                ('state', models.BooleanField(default=True)),
                ('roles', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='myapp.Role')),
        ...
        migrations.CreateModel(
            name='TouristPoint',
            fields=[
                ('idTouristPoint', models.AutoField(primary_key=True, serialize=False)),
                ('name', models.CharField(max_length=100)),
        ...
        migrations.CreateModel(
            name='Route',
            fields=[
                ('idRoute', models.AutoField(primary_key=True, serialize=False)),
                ('name', models.CharField(max_length=100)),
                ('score', models.IntegerField(default=0)),
                ('touristPoints', models.ManyToManyField(to='myapp.TouristPoint')),
        ...
        migrations.CreateModel(
            name='Prize',
            fields=[
                ('idPrize', models.AutoField(primary_key=True, serialize=False)),
